...
import 'package:aluno/app/presentation/controllers/auth/email/auth_register_email_controller.dart';
import 'package:aluno/app/presentation/views/utils/app_appbar.dart';
import 'package:aluno/app/presentation/views/utils/app_button.dart';
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  AppTextFormField(
                    label: 'Número DDD e número do celular (sem espaço)',
                    controller: _phoneEC,
                    validator: Validatorless.multiple([
                      Validatorless.required('Celular obrigatório.'),
                      Validatorless.number('Apenas números'),
                      Validatorless.min(11,
                          'São 11 números DDD e Número sem espaços. Ex.: 12123456789'),
                      Validatorless.max(11, 'Informe DDDNúmero sem espaços'),
                    ]),
                  ),
                  const SizedBox(height: 20),
                  AppTextFormField(
